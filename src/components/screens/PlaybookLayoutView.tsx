    ...
    if (isIndex) {
      return (
        <>
          ...
          <sprite position={[0, 0, 0.22]} scale={[1.82, 0.86, 1]} renderOrder={30}>
            <spriteMaterial map={texture} transparent opacity={viewOpacity} toneMapped={false} depthTest={false} depthWrite={false} />
          </sprite>
        </>
      );
    }
