...
function createSurfaceTextTexture(
  ...
  context.font = `600 ${fontSize}px "Pretendard"`;
  ...
  while (visibleLines.length > 4 && renderFontSize - 8 >= minimumFontSize) {
    renderFontSize -= 8;
    context.font = `600 ${renderFontSize}px "Pretendard"`;
  ...
  backdropGradient.addColorStop(0, "rgba(255, 255, 255, 0.25)");
  backdropGradient.addColorStop(0.38, "rgba(255, 255, 255, 0.14)");
