...
export const cubeSceneTheme = {
  ...
  cube: {
    ...
    glass: {
      ...
      fresnelTint: {
        ...
        instanceShift: 3.2,
        instanceBlend: 0.62,
        colors: ["#e0f2fe", "#38bdf8", "#2563eb", "#4338ca", "#7c3aed", "#d8b4fe"] as const,
      },
      iridescence: 0.16,
      iridescenceIOR: 1.65,
      iridescenceThicknessRange: [160, 520] as const,
      ior: 1.46,
      dispersion: 0.06,
      transmission: 0.88,
      thickness: 1.2,
    ...
    enterMaxStagger: 680,
    enterDuration: 760,
    enterStartScale: 0.84,
    enterLift: -8,
    enterCameraDuration: 1400,
    enterCameraDistance: 150,
    enterCameraSideOffset: 48,
    enterCameraLift: 28,
    enterCameraSweep: 24,
    enterCameraArcLift: 18,
    enterSway: 0.42,
  ...
  hover: {
    spreadDistance: 6.5,
    spreadFalloffUnits: 5.5,
    spreadMinInfluence: 0.1,
    dimScale: 0.96,
    hoverScale: 1.045,
    dimOpacityMultiplier: 0.88,
    positionLerp: 0.075,
    scaleLerp: 0.1,
    materialLerp: 0.08,
    collisionStep: 0.05,
    ...
    boundaryPadding: 0,
    highlightOpacity: 1,
    searchHighlightHoverScale: 1.05,
